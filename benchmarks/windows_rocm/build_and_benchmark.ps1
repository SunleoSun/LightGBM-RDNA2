param(
    ...
    [string]$Profile = 'all',
    [ValidateSet('production', 'smoke', 'stress', 'quantile', 'feature_fraction', 'optuna', 'optuna_long', 'optuna_compat', 'single')]
...
$matrixValidRows = if ($Suite -in @('smoke', 'quantile', 'feature_fraction', 'optuna', 'optuna_compat')) { $SmokeValidRows } else { $ValidRows }
